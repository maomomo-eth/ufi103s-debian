...
> [!NOTE]
> **历史归档**：本文档记录早期 boot/rootfs 制作与实机验证过程，**非当前刷机步骤**。刷机请参阅 [README.md](../README.md) 与 [9008 全盘刷机指南](FLASHING.md)。
...
| --- | --- | --- |
| 中国移动，`+86` | 中国移动 | 正常 |
| 中国电信，`+86` | 中国电信 | 能连接 LTE 数据，无法收发短信（因基带版本过老不支持 VoLTE，而电信已退网 2G/3G 且全面依赖 VoLTE 短信）。 |
