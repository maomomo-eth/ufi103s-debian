...
- giffgaff 能漫游注册到中国移动，但在 UFI103S 上收不到短信；把同一张卡放入手机后也收不到，因此本次现象不能归因于 UFI103S 或 VoCat。
...
| giffgaff 漫游 | 可漫游注册到中国移动 | UFI103S 与手机均收不到 | 优先检查 SIM、账户和漫游侧，不应先改设备固件 |
...
重刷后又把测试卡从电信/giffgaff 换成了中国移动，因此“恢复备份”和“更换运营商”是两个同时变化的变量。中国移动短信成功证明设备链路可用，但不能证明重复写入相同 NV 是修复原因。
